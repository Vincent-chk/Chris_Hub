...
function insertCatalogFixtures() {
  ...
  db.insert(skus)
    .values([
      { id: "s1", productId: "p1", nameCn: "标准版", nameEn: "Standard", tabLabelCn: "标准版", tabLabelEn: "Standard", priceCents: 3900, position: 1, enabled: 1 },
      { id: "s2", productId: "p1", nameCn: "闪卡版", nameEn: "Foil", tabLabelCn: "闪卡版", tabLabelEn: "Foil", priceCents: 8900, position: 2, enabled: 1 },
      { id: "s3", productId: "p2", nameCn: "火焰鸟限定卡", nameEn: null, tabLabelCn: "限定版", tabLabelEn: null, priceCents: 12900, position: 1, enabled: 1 },
      { id: "s4", productId: "p3", nameCn: "草稿SKU", nameEn: null, tabLabelCn: "草稿", tabLabelEn: null, priceCents: 100, position: 1, enabled: 1 },
      { id: "s5", productId: "p4", nameCn: "限定新卡", nameEn: null, tabLabelCn: "限定", tabLabelEn: null, priceCents: 5000, position: 1, enabled: 1 },
    ])
    .run();
  db.insert(skuImages)
    .values([
...
test("getProductDetail: complete published product", () => {
  ...
  assert.deepEqual(detail.skus[0].images, ["/products/card-01.svg"]);
});
