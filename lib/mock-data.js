...
const baseProducts = [
  {
    ...
    skus: [
      { id: "sku-01-a", name: { cn: "宝可梦皮卡丘纪念卡 · 标准版", en: "Pikachu Commemorative Card · Standard" }, tab: { cn: "标准版", en: "Standard" }, price: 39, cardImage: "/products/card-01.svg", detailImages: ["/products/card-01.svg", "/products/card-02.svg"] },
      { id: "sku-01-b", name: { cn: "宝可梦皮卡丘纪念卡 · 闪卡版", en: "Pikachu Commemorative Card · Foil" }, tab: { cn: "闪卡版", en: "Foil" }, price: 89, cardImage: "/products/card-03.svg", detailImages: ["/products/card-03.svg", "/products/card-01.svg"] },
    ],
  },
  {
    id: "product-02",
    ...
    skus: [{ id: "sku-02-a", name: { cn: "火焰鸟限定插画卡", en: "Moltres Limited Illustration" }, tab: { cn: "限定版", en: "Limited" }, price: 129, cardImage: "/products/card-04.svg", detailImages: ["/products/card-04.svg", "/products/card-05.svg"] }],
  },
  {
    id: "product-03",
    ...
    skus: [{ id: "sku-03-a", name: { cn: "森林旅人特别版 · 日文", en: "Forest Traveller · Japanese" }, tab: { cn: "日文版", en: "Japanese" }, price: 69, cardImage: "/products/card-06.svg", detailImages: ["/products/card-06.svg", "/products/card-02.svg"] }],
  },
  {
    id: "product-04",
    ...
    skus: [
      { id: "sku-04-a", name: { cn: "月光龙稀有收藏卡 · 小尺寸", en: "Moon Dragon · Small Format" }, tab: { cn: "小尺寸", en: "Small" }, price: 159, cardImage: "/products/card-02.svg", detailImages: ["/products/card-02.svg", "/products/card-06.svg"] },
      { id: "sku-04-b", name: { cn: "月光龙稀有收藏卡 · 大尺寸", en: "Moon Dragon · Large Format" }, tab: { cn: "大尺寸", en: "Large" }, price: 239, cardImage: "/products/card-05.svg", detailImages: ["/products/card-05.svg", "/products/card-02.svg"] },
    ],
  },
  {
    id: "product-05",
    ...
    skus: [{ id: "sku-05-a", name: { cn: "海岸线训练家卡", en: "Coastline Trainer Card" }, tab: { cn: "标准版", en: "Standard" }, price: 49, cardImage: "/products/card-06.svg", detailImages: ["/products/card-06.svg"] }],
  },
  {
    id: "product-06",
    ...
    skus: [{ id: "sku-06-a", name: { cn: "星尘舞台纪念卡", en: "Stardust Stage Commemorative" }, tab: { cn: "纪念版", en: "Commemorative" }, price: 79, cardImage: "/products/card-03.svg", detailImages: ["/products/card-03.svg", "/products/card-04.svg"] }],
  },
  {
    id: "product-07",
    ...
    skus: [{ id: "sku-07-a", name: { cn: "蓝湾收藏套卡 · 12张", en: "Blue Bay Set · 12 cards" }, tab: { cn: "12张", en: "12 cards" }, price: 99, cardImage: "/products/card-01.svg", detailImages: ["/products/card-01.svg", "/products/card-06.svg"] }],
  },
  {
    id: "product-08",
    ...
    skus: [{ id: "sku-08-a", name: { cn: "赤焰徽章特别卡", en: "Crimson Badge Special Card" }, tab: { cn: "特别版", en: "Special" }, price: 119, cardImage: "/products/card-04.svg", detailImages: ["/products/card-04.svg", "/products/card-03.svg"] }],
  },
];
...
export const PRODUCTS = Array.from({ length: 24 }, (_, index) => {
  ...
  return {
    ...
    skus: base.skus.map((sku, skuIndex) => ({ ...sku, id: `${sku.id}-${index}`, cardImage: sku.cardImage, detailImages: [...sku.detailImages], price: sku.price + (index % 3) * 10 + skuIndex * 3 })),
  };
});
...
export function getCardImage(product) {
  const sku = product.skus.find((item) => item.enabled !== false);
  return sku?.cardImage || sku?.detailImages?.[0] || "/products/card-01.svg";
}
